...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .transform((intervals) => {
      // percorre os intervalos e para cada intervalo retorna um novo objeto
    ...
    .refine(
      (intervals) => {
        // every -> se todos os itens do array cumprem com a regra de existir uma hora pelo menos, some -> apenas um item
        return intervals.every(
          // verifica que o termino do intervalo , aparecem apenas os campos apos a transformacao do zod
          (interval) =>
